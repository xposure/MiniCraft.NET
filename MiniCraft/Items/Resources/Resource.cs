...
namespace MiniCraft.Items.Resources
{
    ...
    public class Resource
    {
        ...
        public static Resource flower = new PlantableResource("Flower", 0 + 4 * 32, ColorHelper.get(-1, 10, 444, 330), Tile.flower, Tile.grass);
        public static Resource acorn = new PlantableResource("Acorn", 3 + 4 * 32, ColorHelper.get(-1, 100, 531, 320), Tile.treeSapling, Tile.grass);
        public static Resource dirt = new PlantableResource("Dirt", 2 + 4 * 32, ColorHelper.get(-1, 100, 322, 432), Tile.dirt, Tile.hole, Tile.water, Tile.lava);
        public static Resource sand = new PlantableResource("Sand", 2 + 4 * 32, ColorHelper.get(-1, 110, 440, 550), Tile.sand, Tile.grass, Tile.dirt);
        public static Resource cactusFlower = new PlantableResource("Cactus", 4 + 4 * 32, ColorHelper.get(-1, 10, 40, 50), Tile.cactusSapling, Tile.sand);
        public static Resource seeds = new PlantableResource("Seeds", 5 + 4 * 32, ColorHelper.get(-1, 10, 40, 50), Tile.wheat, Tile.farmland);
        ...
        public static Resource cloud = new PlantableResource("cloud", 2 + 4 * 32, ColorHelper.get(-1, 222, 555, 444), Tile.cloud, Tile.infiniteFall);
